...
public class GraphicOverlay extends View {
     ...
     * instances to the overlay using {@link com.example.mlkitwithcamera.GraphicOverlay#add(Graphic)}.
     */
    public abstract static class Graphic {
        private com.example.mlkitwithcamera.GraphicOverlay overlay;

        public Graphic(com.example.mlkitwithcamera.GraphicOverlay overlay) {
